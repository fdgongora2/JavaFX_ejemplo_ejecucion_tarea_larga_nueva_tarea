package com.example.ejemplotaskoperacionlarga;
...
public class HelloApplication extends Application {
    ...
    private Parent createMainView() {
        ...
        Button btnGetHTMLSinTask = new Button("Get HTML sin tarea");
        btnGetHTMLSinTask.setOnAction( this::getHTMLSinTask );
        topControls.getChildren().addAll(label, tfURL, btnGetHTML, btnGetHTMLSinTask);
    ...
    public void getHTMLSinTask(ActionEvent evt) {
